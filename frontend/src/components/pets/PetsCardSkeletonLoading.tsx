export default function PetsCardSkeletonLoading() {
    return (
      <div data-testid="pet-card-loading" className="bg-white rounded-2xl shadow-sm border overflow-hidden transition-transform hover:scale-[1.02] hover:shadow-md">
